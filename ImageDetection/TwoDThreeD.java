...
public class TwoDThreeD {
	...
	static float boardSize = 255.f; // large Duplo board
	...
	static float [][] physicalCorners = {{-128,-128,0,1},
									   	 {128,-128,0,1},
										 {128,128,0,1},
										 {-128,128,0,1}};
	...
	public PVector get3DRotations(List<PVector> points2D) {
		...
		// 1- Solve the extrinsic matrix fromake a ruler and measure it, the Lego board is 255x255 mm. Assuming an origin at the centre
		//of the board, the coordinates of the four corners are he the projected 2D points
